...
- [x] CGV du 22 septembre 2026 — délai de retrait et délai de livraison. Retrait sous 20 jours à compter de l'arrivée à Tana, puis gardiennage de 100 000 Ar/jour plafonné à 10 jours, puis résolution de plein droit au 30e jour : MOTO IMPORT garde les frais échus et 15 % du prix, et rembourse le surplus dans les 30 jours de la revente (art. 10, 11). Les risques passent à l'acheteur à la fin des 20 jours (art. 12). Délai de livraison porté à 45-75 jours, variable selon la compagnie maritime et plafonné à 75 jours (art. 9.1, 9.2), suspendu par les événements maritimes (9.3) ; au-delà du maximum plus 15 jours, l'acheteur annule et récupère tout son acompte (9.4). La demande d'immatriculation n'est déposée qu'au retrait : l'acheteur repart avec les clés et le récépissé de dépôt, la carte grise suit (art. 4.3, 7). Délai centralisé dans `lib/conditions.ts` et plafond vérifié à la saisie comme en base (migration 0011)
